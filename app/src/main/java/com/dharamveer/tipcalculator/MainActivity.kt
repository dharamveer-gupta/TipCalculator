...
fun TipTimeLayout() {
    ...
    val tip = calculateTip(amount = amount, tipPercentage = tipPercent, roundUp)
    Column(
        modifier = Modifier
            .statusBarsPadding()
        ...
        Text(
            text = stringResource(id = R.string.calculate_tip), fontWeight = FontWeight.Bold, modifier = Modifier
                .padding(top = 16.dp, bottom = 16.dp)
                .align(Alignment.Start)
        )
        EditNumberField(
            label = R.string.bill_amount, value = amountInput, leadingIcon = R.drawable.money,
        ...
        EditNumberField(
            label = R.string.tip_pratishat, value = tipInput, leadingIcon = R.drawable.percent,
            keyboardOptions = KeyboardOptions.Default.copy(
...
@Composable
fun EditNumberField(
    @StringRes label: Int, @DrawableRes leadingIcon: Int, value: String, keyboardOptions: KeyboardOptions, onValueChange: (String) -> Unit, modifier: Modifier = Modifier
) {
    TextField(
